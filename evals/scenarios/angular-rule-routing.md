...
- [ ] Names the relevant workflow directives, including `.agents/directives/adaptive-routing.md`, TDD/type/verification guidance as appropriate for a typed behavior change.
