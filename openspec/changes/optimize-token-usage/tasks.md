...
- [x] 8.5 Create follow-up issue #91 for provider/model selection, secure usage ingestion, immutable cohort setup, and the provider-attested 24-attempt comparison; keep placeholder evidence invalid and close this implementation change without claiming an empirical token-reduction result.
