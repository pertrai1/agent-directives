# Boundary Diff Reporting Specification

## Purpose

Define deterministic local reports for dependency edges changed by a git comparison while preserving human ownership of architecture judgment.
