# Agent State Reporting Specification

## Purpose

Define deterministic, read-only handoff and decision-record reports that preserve observable repository facts without inventing judgment.
