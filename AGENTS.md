...
| Accessibility                    | Apply UI accessibility requirements for markup, forms, focus, keyboard, ARIA, and tests | `directives/accessibility.md`                    |
...
| A11y Expert                    | When implementing or reviewing frontend files, user-facing UI, or accessibility-sensitive interaction behavior                                                                                                      | `skills/a11y-expert/SKILL.md`                    |
